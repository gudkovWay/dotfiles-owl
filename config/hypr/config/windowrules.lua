...
-- Gaming
-- Workspace 4 lives on DP-3, the 2560x1440 main monitor: games size themselves
-- for it correctly, unlike the ultrawide DP-2.
...
-- Silent placement. Workspaces 1-10 are on DP-3 (main), 11-20 on DP-2 (ultrawide).
local silent = require("config.silent")

-- DP-3, the main monitor: work and games.
silent.window_rule({ match = { class = { "dev.zed.Zed", "dev.zed.Zed-Dev", "zed" } }, workspace = 2 })
silent.window_rule({ match = { class = { "zen", "zen-alpha" } },                      workspace = 3 })
silent.window_rule({ match = { class = "steam" },                                     workspace = gamingWorkspace })

-- DP-2, the ultrawide: chat and music.
silent.window_rule({ match = { class = { "discord", "vesktop" } }, workspace = 11 })
silent.window_rule({ match = { class = "com.ayugram.desktop" },    workspace = 11 })
silent.window_rule({ match = { class = "YouTube Music Desktop App" }, workspace = 12 })
